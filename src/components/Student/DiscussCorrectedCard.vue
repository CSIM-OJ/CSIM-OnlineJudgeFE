    ...
    <el-card class="box-card" style="margin-top: 15px; " shadow="hover">
      <div class="text item">
        <el-row class="block border-dashed">
          ...
          <el-col :span="14">
            <el-slider class="correct-slider" v-model="stud.correctValue.score" :disabled="true"></el-slider>
          </el-col>
          <el-col :span="4">
        ...
        <el-row class="block border-dashed">
          ...
          <el-col :span="14">
            <el-slider class="correct-slider" v-model="stud.readValue.score" :disabled="true"></el-slider>
          </el-col>
          <el-col :span="4">
        ...
        <el-row class="block border-dashed">
          ...
          <el-col :span="14">
            <el-slider class="correct-slider" v-model="stud.skillValue.score" :disabled="true"></el-slider>
          </el-col>
          <el-col :span="4">
        ...
        <el-row class="block border-dashed">
          ...
          <el-col :span="14">
            <el-slider class="correct-slider" v-model="stud.completeValue.score" :disabled="true"></el-slider>
          </el-col>
          <el-col :span="4">
        ...
        <el-row class="block border-dashed">
          ...
          <el-col :span="14">
            <el-slider class="correct-slider" v-model="stud.wholeValue.score" :disabled="true"></el-slider>
          </el-col>
          <el-col :span="4">
