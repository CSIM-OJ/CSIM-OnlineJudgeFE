...
<div>
    ...
    <el-container>
      ...
      <el-container>
        <el-main>
          ...
          <table-problem-data :problemData="tableData" :tableLoading='loading' @refreshProblemsData="refreshProblemsData" @showViewProblemDialog="showViewProblemDialog"></table-problem-data>
  ...
  <!-- TODO: view problem dialog -->
  <view-problem-dialog :viewProblemDialogVisible="viewProblemDialogVisible" :viewProblemLoading="viewProblemLoading" :problemData="problemData"></view-problem-dialog>
  <!-- view problem dialog start -->
  <!-- <el-dialog id="viewProblemDialog" :visible.sync="problemDialogVisible" v-loading="viewProblemLoading">
...
import TableProblemData from '@/components/TableProblemData'
import ViewProblemDialog from '@/components/ViewProblemDialog'
